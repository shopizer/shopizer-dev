...
public class QProductImage extends EntityPathBase<ProductImage> {
    ...
    public final ListPath<ProductImageDescription, QProductImageDescription> descriptions = this.<ProductImageDescription, QProductImageDescription>createList("descriptions", ProductImageDescription.class, QProductImageDescription.class);
