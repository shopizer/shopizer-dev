...
public class QZone extends EntityPathBase<Zone> {
    ...
    public final ListPath<ZoneDescription, QZoneDescription> descriptions = this.<ZoneDescription, QZoneDescription>createList("descriptions", ZoneDescription.class, QZoneDescription.class);
